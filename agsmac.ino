...
//WiFi_SSID
  ...
  bool IsValid=ValidateIPv4Address(Test);
  if(IsValid)
  {
    Serial.println(Test+" is a valid IPv4 address");
  }
  else
  {
    Serial.println(Test+" is NOT a valid IPv4 address");
  }
  Test="192.168.1.256";
  IsValid=ValidateIPv4Address(Test);
  if(IsValid)
  {
    Serial.println(Test+" is a valid IPv4 address");
  }
  ...
  Serial.println(OmNomNomSD(Test,"."));
  Serial.println(OmNomNomSD(Test,"."));
  Serial.println(OmNomNomSD(Test,"."));
  Serial.println(OmNomNomSD(Test,"."));
}
